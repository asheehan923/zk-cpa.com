    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center w-full">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-[#2b3947]">
            Get In Touch With Us
          </h1>
          <p className="mt-4 text-[#4a6080] text-lg">
      ...
      <section className="py-20 bg-[#F7F8FA]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            {/* Contact Info */}
            <div>
              <h2 className="text-2xl font-bold text-[#2b3947] mb-6">Contact Information</h2>

              <div className="space-y-6">
                {/* Address */}
                <div className="flex gap-4">
                  <div className="flex-shrink-0 w-10 h-10 bg-[#2b3947] rounded-lg flex items-center justify-center">
                  ...
                  <div>
                    <p className="font-semibold text-[#2b3947] text-sm">Office Address</p>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <p className="font-semibold text-[#2b3947] text-sm">Phone</p>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <p className="font-semibold text-[#2b3947] text-sm">Email</p>
              ...
              <a
                ...
                className="mt-3 inline-flex items-center gap-1 text-sm text-[#00AEEF] hover:text-[#2b3947] transition-colors font-medium"
              >
                Open in Google Maps
            ...
            <div className="bg-white rounded-xl shadow-md p-8">
              <h2 className="text-2xl font-bold text-[#2b3947] mb-2">Send Us a Message</h2>
